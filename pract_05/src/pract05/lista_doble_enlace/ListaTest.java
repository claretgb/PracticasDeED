...
public class ListaTest {
	...
	public void testConstructor() {
		...
		ILista<String> lst = new ListaDobleEnlace<String>(5);
	...
	public void testSuperaCapacidad() {
		...
		ILista<Character> lst = new ListaDobleEnlace<Character>(capacidadInicial);
		Character c;
	...
	public void testIteradorRecorre() {
		...
		ILista<Character> lst = new ListaDobleEnlace<Character>(5);
